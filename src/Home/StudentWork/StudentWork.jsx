...
import { FaThumbsUp, FaThumbsDown, FaRegCopy, FaVolumeUp, FaFileAlt, FaCommentDots } from "react-icons/fa";
...
const StudentWork = () => {
    return (
     ...
     <div className="flex items-center gap-10">
      ...
      <h2 className="text-xl font-semibold text-blue-900 mb-4">Real-time Analysis</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl flex items-center space-x-3 hover:shadow cursor-pointer transition">
          ...
          <span className="text-sm font-medium text-gray-800">Generate Script</span>
        </div>

        {/* Action 2 */}
        <div className="bg-white p-4 rounded-xl flex items-center space-x-3 hover:shadow cursor-pointer transition">
          <FaCommentDots className="text-blue-900 text-xl" />
          <span className="text-sm font-medium text-gray-800">Practice Pitch</span>
        </div>
      </div>
    </div>
         </div>
