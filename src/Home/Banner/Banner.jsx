       ...
       <div className="bg-white">
          ...
          <div className=" flex-1 ">
            <div className="relative flex justify-end items-end">
              <img className="w-[400px] flex justify-between" src={other} alt="" />
              <div className="w-max absolute top-[80%] left-[20%] h-72 border-blue-300 p-10 bg-white shadow-2xl rounded-2xl"> 
                ...
                <h1 className="text-3xl pb-4 text-black font-bold">Growth is our priority</h1>
